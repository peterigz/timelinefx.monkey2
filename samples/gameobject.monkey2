...
Class CollisionTest Extends Window
	...
	Method New()
		...
		Local ship:=LoadShape("asset::explosion.png",96 , 96, 48)
		testobject = New tlGameObject
		testobject.SetImage(ship)
		testobject.SetPosition(100, 100)
		testobject.BlendMode = BlendMode.Alpha
		testobject.FrameRate = 30
	End
